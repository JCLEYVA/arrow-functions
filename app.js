...
//This is because scope is a method on the Student prototype, 
//and when a method is called on an object, this refers to the object that 
//the method is called on.
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked, this refers to the global this object,
//which is probably the Window object in a browser environment. 
//This is because scopeArrow is an arrow function, and arrow functions do not 
//have their own this context. 
//
// 3. Explain why "this" is different when an arrow function is used.
//Arrow functions do not have their own this context, so they always use 
//the this value of the surrounding lexical context. 